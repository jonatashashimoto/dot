...
},{"./src/faker":30}],3:[function(require,module,exports){
...
},{"./src/estados":7,"./src/faker":8,"./src/mask":14,"./src/placa":16,"./src/utils":18,"./src/validate":19}],6:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./estados":7,"./utils":18}],7:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"../addons/pessoas":4,"./create":6,"./inscricaoestadual":9,"./iptu/create":10,"./mask":14,"./name":15,"./placa":16,"./utils":18,"./validate":19,"./veiculos":20,"randexp":21}],9:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var utils_1 = require("./utils");
/**
...
},{"../utils":18,"./mask":12}],11:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var validate_1 = require("./validate");
var mask_1 = require("./mask");
...
},{"../utils":18,"./create":10,"./mask":12,"./validate":13}],12:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.IPTUMASKS = {
    'minas-gerais': {
...
},{"../utils":18,"./create":10}],14:[function(require,module,exports){
"use strict";
var __assign = (this && this.__assign) || function () {
    __assign = Object.assign || function(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
...
},{"./inscricaoestadual":9,"./iptu/iptu":11,"./utils":18,"text-mask-addons/dist/createNumberMask":27}],15:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./estados":7}],19:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var utils_1 = require("./utils");
var inscricaoestadual_1 = require("./inscricaoestadual");
...
},{"./create":6,"./estados":7,"./inscricaoestadual":9,"./iptu/iptu":11,"./placa":16,"./rg":17,"./utils":18}],20:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"drange":3,"ret":22}],22:[function(require,module,exports){
...
},{"./positions":23,"./sets":24,"./types":25,"./util":26}],23:[function(require,module,exports){
const types = require('./types');
...
},{"./sets":24,"./types":25}],27:[function(require,module,exports){
...
},{"./estados":29,"./utils":36}],29:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
Object.defineProperty(exports, "__esModule", { value: true });
var js_brasil_1 = require("js-brasil");
var randexp_1 = require("randexp");
var placa_1 = require("./placa");
var inscricaoestadual_1 = require("./inscricaoestadual");
var create_1 = require("./create");
...
// import cnaes from '../addons/cnaes';
var CEPRange = {};
var MASKS = js_brasil_1.utilsBr.MASKS;
var validate_cns = js_brasil_1.validateBr.cns, validate_titulo = js_brasil_1.validateBr.titulo; // TODO: CEPRange
function aih(uf, ano, tipo, seq) {
    if (uf === void 0) { uf = 35; }
    if (ano === void 0) { ano = 19; }
    if (tipo === void 0) { tipo = 1; }
    if (seq === void 0) { seq = null; }
    if (!seq) {
        seq = (0, utils_1.randomNumber)(1000000, 9999999); // new Random().Next(1, 9999999).ToString().PadLeft(7, '0');
    }
    var cod = parseInt("".concat(uf).concat(ano).concat(tipo).concat(seq));
    var digito = (0, create_1.create_aih)(cod);
    var result = "".concat(cod).concat(digito);
    return result;
}
function celular(options) {
    if (options === void 0) { options = {}; }
...
function cep(options) {
    if (options === void 0) { options = {}; }
    if (!options.estado) {
        options.estado = (0, utils_1.randomEstadoSigla)();
    }
    var range = pessoas_1.CEP_ESTADO[options.estado];
    var cepNumber = (0, utils_1.randomNumber)(range[0][0], range[0][1]);
    var cep;
    if (cepNumber < 10000000) {
        cep = '0' + cepNumber.toString();
    }
...
function cepState(state) {
    return (0, randexp_1.randexp)(CEPRange[state]);
}
function certidao() {
    var value = (0, utils_1.makeGenericFaker)(MASKS['certidao'])();
    var certidao = (0, utils_1.getAllDigits)(value);
    var check = (0, create_1.create_certidao)(certidao);
    return certidao.substr(0, certidao.length - 2) + check;
}
function chassi() {
    var chassi = (0, utils_1.makeGenericFaker)(MASKS['chassi'])();
    chassi = chassi.replace(/i|I|o|O|q|Q/g, 'A');
    return chassi;
}
function cid() {
...
var cnae = (0, utils_1.makeGenericFaker)(MASKS['cnae']);
function cnh() {
    var cnh = (0, utils_1.makeGenericFaker)(MASKS['cnh'])();
    var check = (0, create_1.create_cnh)(cnh);
    return cnh.substr(0, cnh.length - 2) + check;
}
function renachseguranca() {
    var renachseguranca = (0, utils_1.makeGenericFaker)(MASKS['renachseguranca'])();
    var check = (0, create_1.create_renachseguranca)(renachseguranca);
    return renachseguranca.substr(0, renachseguranca.length - 1) + check;
}
function renachestadual() {
    var renachestadual = (0, utils_1.makeGenericFaker)(MASKS['renachestadual'])();
    renachestadual = (0, utils_1.randomEstadoSigla)() + renachestadual.substr(2, renachestadual.length);
    var check = (0, create_1.create_renachestadual)(renachestadual);
    return renachestadual.substr(0, renachestadual.length - 1) + check;
}
function cnhespelho() {
    var cnhespelho = (0, utils_1.makeGenericFaker)(MASKS['cnhespelho'])();
    var check = (0, create_1.create_cnhespelho)(cnhespelho);
    return cnhespelho.substr(0, cnhespelho.length - 1) + check;
}
function cnpj() {
    var cnpj = (0, utils_1.makeGenericFaker)(MASKS['cnpj'])();
    cnpj = cnpj.replace(/[^\d]+/g, '');
    var restos = (0, create_1.create_cnpj)(cnpj) || [0, 1];
    cnpj = cnpj.substr(0, cnpj.length - 2) + restos[0] + restos[0];
    restos = (0, create_1.create_cnpj)(cnpj) || [0, 1];
    return cnpj.substr(0, cnpj.length - 1) + restos[1];
}
function cns() {
    var cns;
    do {
        cns = (0, utils_1.makeGenericFaker)(MASKS['cns'])();
        cns = (0, utils_1.getAllDigits)(cns);
        var primeiroDigito = parseInt(cns[0]);
        if (primeiroDigito < 3) {
            var cnsDigits = cns.split('');
            cnsDigits[cnsDigits.length - 2] = '0';
        ...
        var digito = (0, create_1.create_cns)(cns);
        cns = cns.substr(0, cns.length - 2) + digito;
    } while (!validate_cns(cns));
    return cns;
}
var contabanco = (0, utils_1.makeGenericFaker)(MASKS['contabanco']);
function cpf() {
    var cpf_fake = (0, utils_1.makeGenericFaker)(MASKS['cpf'])();
    var restos = (0, create_1.create_cpf)(cpf_fake);
    if (!restos) {
        throw new Error('Could not create cpf on faker cpf');
    }
    cpf_fake = cpf_fake.substr(0, cpf_fake.length - 2) + restos[0] + restos[1];
    restos = (0, create_1.create_cpf)(cpf_fake);
    if (!restos) {
        throw new Error('Could not create cpf on faker cpf');
    }
    cpf_fake = cpf_fake.substr(0, cpf_fake.length - 2) + restos[0] + restos[1];
...
var cpfcnpj = (0, utils_1.makeGenericFaker)(MASKS['cpfcnpj']);
var cartaocredito = (0, utils_1.makeGenericFaker)(MASKS['cartaocredito']);
function currency() {
    var x = Math.random() * 10000;
    var final = x.toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' });
    if (final[final.length - 3] === '.') {
...
function data(config) {
    ...
    if (config.idadeMin && config.idadeMax) {
        config.anos = -(0, utils_1.randomNumber)(config.idadeMin, config.idadeMax);
    }
    if (config.anos) {
        date.setFullYear(date.getFullYear() + config.anos);
    }
...
function datahora(config) {
    if (config === void 0) { config = {}; }
    return data(config) + ' ' + time();
}
function date(config) {
    if (config === void 0) { config = {}; }
    return data(__assign(__assign({}, config), { lang: 'en' }));
}
function datetime(config) {
    if (config === void 0) { config = {}; }
    return data(__assign(__assign({}, config), { lang: 'en' })) + ' ' + time();
}
function ect() {
    var ect = (0, utils_1.makeGenericFaker)(MASKS['ect'])();
    var dv = (0, create_1.create_ect)(ect.substr(0, ect.length - 1));
    return ect.substr(0, ect.length - 1) + dv;
}
function email(options) {
    if (options === void 0) { options = {}; }
    var nome = (0, utils_1.randArray)(pessoas_1.NOMES_MASCULINOS);
    if (options.nome) {
        nome = options.nome;
    }
    nome = (0, utils_1.slugify)(nome);
    var empresa = nome;
    if (options.empresa) {
        empresa = options.empresa;
    }
...
function empresa(options) {
    ...
    var nome = (0, utils_1.randArray)(pessoas_1.EMPRESAS_TIPOS) + ' ' + (0, utils_1.randArray)(pessoas_1.EMPRESAS_NOMES);
    // const site = faker.site();
    var emailVal = email({
        nome: 'contato',
        empresa: nome
...
function endereco(options) {
    ...
    var estadoFound = name_1.LOCALIZACAO_ESTADOS.find(function (e) { return e.uf.toLowerCase() === options.estado; }) || name_1.LOCALIZACAO_ESTADOS[0];
    var cidades = name_1.LOCALIZACAO_CIDADES.filter(function (c) { return c[1] === estadoFound.nome; });
    var cidade = (0, utils_1.randArray)(cidades);
    var estado = cidade[1].toLowerCase();
    estado = name_1.LOCALIZACAO_ESTADOS.find(function (e) { return e.nome.toLowerCase() === estado.toLowerCase(); });
    return {
        cep: cep(),
        logradouro: (0, utils_1.randArray)(name_1.LOCALIZACAO_RUAS),
        complemento: (0, utils_1.randArray)(name_1.LOCALIZACAO_COMPLEMENTOS) + ' ' + number({ min: 1, max: 10, decimals: 0 }),
        numero: number({ min: 1, decimals: 0 }),
        bairro: (0, utils_1.randArray)(name_1.LOCALIZACAO_BAIRROS),
        cidade: cidade[0],
        estado: cidade[1],
        estadoSigla: estado.uf
    };
...
var inscricaoestadual = function (estadoInput) {
    var estado = estadoInput.toLowerCase();
    if (!inscricaoestadual_1.MASKSIE) {
        return;
    }
    var funcIE = (0, utils_1.getSpecialProperty)(inscricaoestadual_1.MASKSIE, estado);
    var val = (0, utils_1.makeGenericFaker)(funcIE)();
    val = val.match(/\d/g).join('');
    var newval = inscricaoestadual_1.generateInscricaoEstadual[estado](val);
    return newval;
};
function iptu(estado, cidade) {
    return (0, create_2.faker_iptu)(estado, cidade);
}
function number(options) {
    if (options === void 0) { options = {}; }
    if (!options.max) {
...
var porcentagem = (0, utils_1.makeGenericFaker)(MASKS['porcentagem']);
function pessoa(options) {
    if (options === void 0) { options = {}; }
    if (!options.estado) {
        options.estado = (0, utils_1.randomEstadoSigla)();
    ...
    var altura = '1.' + (0, utils_1.randomNumber)(35, 90);
    var peso = (0, utils_1.randomNumber)(50, 120);
    var signo = (0, pessoas_1.getAstro)(dataNascimento);
    var tipoSanguineo = (0, utils_1.randArray)(pessoas_1.TIPOS_SANGUINEOS);
    var sobrenomePai = (0, utils_1.randArray)(pessoas_1.SOBRENOMES);
    var sobrenomeMae = (0, utils_1.randArray)(pessoas_1.SOBRENOMES);
    var nome = (0, utils_1.randArray)(pessoas_1.NOMES_MASCULINOS) + ' ' + sobrenomeMae + ' ' + sobrenomePai;
    var mae = (0, utils_1.randArray)(pessoas_1.NOMES_FEMININOS) + ' ' + sobrenomeMae + ' ' + sobrenomePai;
    var pai = (0, utils_1.randArray)(pessoas_1.NOMES_MASCULINOS) + ' ' + (0, utils_1.randArray)(pessoas_1.SOBRENOMES) + ' ' + sobrenomePai;
    return {
        nome: nome,
        mae: mae,
        pai: pai,
...
function pispasep() {
    var pis = (0, utils_1.makeGenericFaker)(MASKS['pispasep'])();
    var digit = (0, create_1.create_pispasep)(pis);
    var values = pis.split('');
    values[values.length - 1] = digit;
    return values;
}
function placa() {
    var placa;
    do {
        placa = (0, utils_1.makeGenericFaker)(MASKS['placa'])();
    } while (!(0, placa_1.validate_placa)(placa));
    return placa;
}
var processo = (0, utils_1.makeGenericFaker)(MASKS['processo']);
function renavam() {
    var renavam = (0, utils_1.makeGenericFaker)(MASKS['renavam'])();
...
function rg(options) {
    ...
    var estado = options.estado.split('');
    var makeRg = (0, utils_1.makeGenericFaker)(MASKS['rg'], {
        0: function () { return estado[0]; },
        1: function () { return estado[1]; }
    });
    return makeRg();
...
function senha(options) {
    ...
    var pass = [
        (0, utils_1.randomLetter)().toLowerCase(),
        (0, utils_1.randomLetter)().toUpperCase(),
        (0, utils_1.randomNumber)(0, 9),
        (0, utils_1.randArray)(['!', '@', '#', '$', '%', '^', '&', '*'])
    ];
    var i = 4;
    for (i = 4; i <= options.size; i++) {
        var newchar = (0, utils_1.randArray)([
            (0, utils_1.randomLetter)().toLowerCase(),
            (0, utils_1.randomLetter)().toUpperCase(),
            (0, utils_1.randomNumber)(0, 9),
            (0, utils_1.randArray)(['!', '@', '#', '$', '%', '^', '&', '*'])
...
function site(options) {
    ...
    var nome = (0, utils_1.randArray)(pessoas_1.EMPRESAS_TIPOS) + ' ' + (0, utils_1.randArray)(pessoas_1.EMPRESAS_NOMES);
    var dominio = '.com.br';
    var url = (0, utils_1.randArray)(['http://', 'https://']);
    if (options.nome) {
        nome = options.nome;
    }
    if (options.dominio) {
...
var sped = (0, utils_1.makeGenericFaker)(MASKS['sped']);
function telefone(options) {
    if (options === void 0) { options = {}; }
    var telefone = (0, utils_1.makeGenericFaker)(MASKS['telefone'])();
    if (options.estado) {
        var telefones = telefone.toString().split('');
        var ddd = pessoas_1.TELEFONE_ESTADO[options.estado.toLowerCase()].toString();
        telefones[1] = ddd[0];
...
var time = (0, utils_1.makeGenericFaker)(MASKS['time']);
function titulo() {
    var titulo;
    do {
        titulo = (0, utils_1.makeGenericFaker)(MASKS['titulo'])();
        var number_1 = titulo.substr(0, titulo.length - 2);
        if (number_1.substr(-2) === '29') {
            var numbers = number_1.split();
            numbers[numbers.length - 1] = '8';
        ...
        try {
            var dig = (0, create_1.create_titulo)(number_1);
            titulo = number_1 + dig[0] + dig[1];
        }
        catch (e) {
        }
...
function veiculo() {
    var veiculo = (0, utils_1.randArray)(veiculos_1.VEICULOS);
    return {
        placa: placa(),
        chassi: chassi(),
        marca: veiculo.marca,
        modelo: veiculo.modelo,
        categoria: (0, utils_1.randArray)(veiculos_1.VEICULOS_CATEGORIAS),
        especie: (0, utils_1.randArray)(veiculos_1.VEICULOS_ESPECIES),
        restricao: (0, utils_1.randArray)(veiculos_1.VEICULOS_RESTRICOES),
        tipo: (0, utils_1.randArray)(veiculos_1.VEICULOS_TIPOS),
        carroceria: (0, utils_1.randArray)(veiculos_1.VEICULOS_CARROCERIAS),
        combustivel: (0, utils_1.randArray)(veiculos_1.VEICULOS_COMBUSTIVEIS),
        cor: (0, utils_1.randArray)(utils_1.CORES)
    };
}
function usuario(nome) {
    if (!nome) {
        var sobrenomePai = (0, utils_1.randArray)(pessoas_1.SOBRENOMES);
        nome = (0, utils_1.randArray)(pessoas_1.NOMES_MASCULINOS) + ' ' + sobrenomePai;
    }
    return (0, utils_1.slugify)(nome);
}
exports.default = {
    aih: aih,
    cartaocredito: cartaocredito,
...
},{"../addons/pessoas":1,"./create":28,"./inscricaoestadual":31,"./iptu/create":32,"./name":34,"./placa":35,"./utils":36,"./veiculos":37,"js-brasil":5,"randexp":21}],31:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.validate_inscricaoestadual = exports.generateInscricaoEstadual = exports.MASKSIE = void 0;
var utils_1 = require("./utils");
/**
 * BASED ON https://github.com/gammasoft/ie/
 */
...
var faker_iptu = function (estado, cidade) {
    ...
    var iptu = (0, utils_1.makeGenericFaker)(mask_1.IPTUMASKS[estado][cidade])();
    if (exports.IPTUCREATE[estado] && exports.IPTUCREATE[estado][cidade]) {
        var dv = exports.IPTUCREATE[estado][cidade](iptu);
        var values = iptu.split('');
        values[values.length - 1] = dv;
...
},{"../utils":36,"./mask":33}],33:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./estados":29}],37:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
