...
// The large glitch duration variables are commented out as they are no longer needed
// #define DURATION 10.
// #define AMT .1
...
void mainImage( out vec4 fragColor, in vec2 fragCoord )
{
    ...
    // FIX: Set to 0.0 to completely disable the massive periodic glitch.
    // This leaves only the small rolling line glitches active.
    ...
    // These are the small tearing lines you wanted to keep
